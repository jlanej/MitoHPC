...
if [ -n "$SV_MODE" ]; then
  ...
  for v in HP_SV_DUP HP_SV_INV HP_SV_INV_MINAFJ HP_SV_INV_MINJR HP_SV_MITOBREAK_TOL \
           HP_SV_PLOT_ALL HP_SV_PLOT_MINAF HP_SV_PLOT_PASS HP_SV_PLOT_SKIP HP_SV_PLOT_MINSVCONF HP_SV_PLOT_MAX HP_SV_PLOT_DEDUP HP_SV_PLOT_ANNOT; do
